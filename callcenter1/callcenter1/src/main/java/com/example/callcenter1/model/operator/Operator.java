...
public class Operator {
    ...
    @Column(name = "security_text", nullable = false)
    private boolean securityText;
    ...
    public boolean isSecurityText() { return securityText; }
    public void setSecurityText(boolean securityText) { this.securityText = securityText; }
} 
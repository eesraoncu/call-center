    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/register", "/swagger-ui/**", "/v3/api-docs/**", "/api/calls/**", "/api/customers/**", "/api/operators/**", "/api/logs/**", "/api/roles/**", "/api/admins/**", "/api/services/**", "/api/locations/**").permitAll()//burada tanımlanan endpointler dışarıdan erişilebilir.
